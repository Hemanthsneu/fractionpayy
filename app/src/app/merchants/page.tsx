  ...
  return (
    <div>
      <header className="mb-8">
        <p className="text-sm uppercase tracking-widest text-emerald-300/80">Merchant tools</p>
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        {demoMerchants.map((m) => {
          ...
          return (
            <div
              key={m.ensName}
              className="rounded-2xl border border-white/10 bg-white p-5 text-center text-black"
            >
